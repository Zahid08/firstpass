                            ...
                            <?php if(auth()->guest()): ?>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="position-relative confirm_pass">
                                        <input type="password" class="form-control password_icon confirm_password_icon_none" id="password" value="" placeholder="•••••••••••" name="confirm_password" style="font-size: 16px;">
                                        <i class="toggle-password fa fa-fw fa-eye-slash"></i>
...
<?php echo $__env->make('frontend.layouts.cart',['mainclass'=>'cart'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/zenstech/public_html/resources/views/learner/register.blade.php ENDPATH**/ ?>