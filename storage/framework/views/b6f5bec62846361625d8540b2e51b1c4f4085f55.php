                        ...
                        <div class="dl_duration test_booking">
                            ...
                            <div class="dl_hours_duration">
                                <form class="row" action="">
                                    <div class="col-12">
                                        <select class="form-select availability_check choose_location mx-auto" aria-label="Default select example" id="test_location_date" name="test_location_date">
                                    ...
                                    <div class="col-sm-6 col-12 mt-3  justify-content-sm-end justify-content-center" id="show_slots1" style="display: none">
                                        <select class="form-select availability_check" aria-label="Default select example">
                                    ...
                                    if($search->step_2!='' || auth()->user()){
                                        ...
                                        if($step_2 && in_array('test', $step_2) || auth()->user() ){
                                            ...
                                            ?>
                                            <div class="col-sm-6 col-12 mt-3 mb-sm-0 mb-2  justify-content-sm-start justify-content-center" id="test_location" style="display: none">
                                                <select class="form-select availability_check" aria-label="Default select example" name="test_location" id="test_location">
                                                    <option value="0">Select Test locations</option>
...
<?php echo $__env->make('frontend.layouts.cart',['mainclass'=>'cart'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/zenstech/public_html/resources/views/search/book.blade.php ENDPATH**/ ?>