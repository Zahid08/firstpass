...
<?php $__env->startSection('content'); ?>
    ...
    <link href="<?php echo e(asset('assets/libs/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css')); ?>" rel="stylesheet">

    <link href="<?php echo e(asset('assets/libs/bootstrap-material-datetimepicker/css/bootstrap-material-datetimepicker.css')); ?>" rel="stylesheet">
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script src="<?php echo e(asset('assets/libs/bootstrap-material-datetimepicker/js/bootstrap-material-datetimepicker.js')); ?>"></script>
        ...
        ! function($) {
            ...
            var CalendarApp = function() {
                ...
                CalendarApp.prototype.onEventClick = function(calEvent, jsEvent, view) {
                    ...
                    if(id!='') {
                        ...
                        $.post('<?php echo e(url('show-event')); ?>',
                    ...
                    CalendarApp.prototype.onSelect = function (start, end, allDay) {
                        ...
                        $this.$modal.find('form').on('submit', function () {
                            ...
                            var title = form.find("input[name='detail']").val();
                                ...
                                $.post('<?php echo e(url('add_event')); ?>',

                                    {start_time:start_time, end_time:end_time, title:title, start:startDate, end:endDate, detail:detail, address:address, note:note, _token : '<?php echo e(csrf_token()); ?>'},
            ...
            CalendarApp.prototype.init = function() {
                ...
                var defaultEvents = [
                        ...
                        //"title": "<?php echo e($val->detail==""? 'FirstPass lessons': $val->detail); ?>",

                        "title": '<?php echo e(ucfirst($val->user_detail->name)); ?> - <?php echo e($lesson_name); ?>',

                        "start": "<?php echo e($start_date); ?>",

                        "end": "<?php echo e($end_date); ?>",
    ...
    console.log(defaultEvents)
                ...
                $this.$calendarObj = $this.$calendar.fullCalendar({
                    ...
                    businessHours: <?php echo json_encode($avl); ?>,
...

        {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    $.post('<?php echo e(url("delete-event")); ?>',{id:x, _token:"<?php echo e(csrf_token()); ?>"},function(res){
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/zenstech/public_html/resources/views/instructor/calendar.blade.php ENDPATH**/ ?>