...
<?php $__env->startSection('content'); ?>
    ...
    <section class="hero_section position-relative">
        <img src="<?php echo url ('frontend_assets/images/hero-bg.jpg'); ?>" class="img-fluid hero-bg-mob" alt="">
                ...
                <div class="row gx-3 gx-lg-4 gy-4 gy-lg-0 d-flex justify-content-center">
                    <div class="col-lg-4 col-md-6 col-12 d-flex d-md-block justify-content-center">
                        <div class="service_box service_1">
                            <div class="service_img">
                                <img src="<?php echo url ('frontend_assets/images/find-driving-instructor.png'); ?>" class="img-fluid" alt="">
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-12 d-flex d-md-block justify-content-center">
                        <div class="service_box service_2">
                            <div class="service_img">
                                <img src="<?php echo url ('frontend_assets/images/book-driving-lessons.png'); ?>" class="img-fluid" alt="">
                            </div>
                            <div class="service_content">
                    ...
                    <div class="col-lg-4 col-md-6 col-12 d-flex d-md-block justify-content-center">
                        <div class="service_box service_3 pt-0">
                            <div class="service_img">
                                <img src="<?php echo url ('frontend_assets/images/start-learning.png'); ?>" class="img-fluid" alt="">
                            </div>
                            <div class="service_content">
            ...
            <div class="row">
                <div class="col-md-6 d-flex align-items-center justify-content-center justify-content-md-end">
                    <div class="driving_test_img_wrapper text-end">
                        <img src="<?php echo url ('frontend_assets/images/driving-test-package.png'); ?>" alt="">
                        <div class="priceing_box">
                            <p>Only<br>
                                <span>$<?php echo e($test->price); ?> </span>
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 d-flex align-items-end">
                    <div class="driving_test_content">
                        ...
                        <a class="btn btn-primary book_test_package" href="<?php echo e(route('testpack')); ?>">Book Test Packages Now</a>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="whay_first_content">
                        ...
                        <a class="btn btn-primary book_now_btn" href="<?php echo e(URL::to ('/driving-lessons#dlesson')); ?>">Book Now</a>
                    </div>
                </div>
                <div class="col-md-6 d-flex align-items-center justify-content-center justify-content-md-start">
                    <div class="whay_first_img_wrapper text-start">
                        <img src="<?php echo url ('frontend_assets/images/why-choose-first-pass.png'); ?>" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-6 col-12">
                    <div class="experience-card">
                        <img class="card-icon" src="<?php echo url ('frontend_assets/images/car-cap.png'); ?>" />
                ...
                <div class="col-md-6 col-12">
                    <div class="experience-card card-two">
                        <img class="card-icon" src="<?php echo url ('frontend_assets/images/learn-car.png'); ?>" />
                ...
                <div class="col-md-6 col-12">
                    <div class="experience-card card-three">
                        <img class="card-icon" height="74px" src="<?php echo url ('frontend_assets/images/drivers-licence.png'); ?>" />
                ...
                <div class="col-md-6 col-12">
                    <div class="experience-card card-four">
                        <img class="card-icon" src="<?php echo url ('frontend_assets/images/calendar.png'); ?>" />
...
<?php echo $__env->make('frontend.layouts.app_guest', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp7.4.9\htdocs\firstpass\resources\views/frontend/home/index.blade.php ENDPATH**/ ?>