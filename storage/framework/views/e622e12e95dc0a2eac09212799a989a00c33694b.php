        ...
        <div id="accordion">
            ...
            <div class="card">
                <div class="card-header" id="headingOne" style="background: #4bd396;">
                    <h5 class="mb-0" style="color: #ffffff;">
                        <?php if(Request::get('type') == 'users'): ?>
                        Total Users
                        <?php elseif(Request::get('type') == 'inst'): ?>
                        Total Instructors
                        <?php elseif(Request::get('type') == 'learner'): ?>
                        Total Learners
                        <?php else: ?>
                        ALL USERS
                        <?php endif; ?>
        ...
        <?php $__env->startSection('scripts'); ?>
            ...
            <script>
                    ...
                    var table =  $('#users_table').DataTable({
                        ...
                        "drawCallback": function () {
                            $('.myswitch').change(function () {
                                ...
                                $.post('<?php echo e(route('update-status')); ?>',
                        ...
                        "ajax": "<?php echo e(url('get-users')); ?><?php echo e($type ? '?type=' . $type : ''); ?>",
                        "columns":[
                            { "data": "id", name:'id' },
                            { "data": "name", name:'name' },
                ...
                function add_credit(id) {
                    ...
                    $.get("<?php echo e(url('get-credits')); ?>", {id:id}, function (res) {
                        $("#loading").hide();
                        if (res.success == true) {
                ...
                function del_user(x)
                {
                    ...
                    Swal.fire({
                        ...
                        if (result.value) {
                            $("#loading").show();
                            $.post('<?php echo e(route("delete-user")); ?>',{id:x, _token:"<?php echo e(csrf_token()); ?>"},function(res){
                                $("#loading").hide();
                ...
                function login_client(id) {
                    $.post('<?php echo e(route('user-login')); ?>',
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp7.4.9\htdocs\firstpass\resources\views/admin/view_users.blade.php ENDPATH**/ ?>