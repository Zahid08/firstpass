...
<div class="container-fluid">
        ...
        <div class="col-lg-12">
            <div class="card  bg-light no-card-border">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="m-r-10">
                            <img src="assets/images/users/<?php echo e(auth()->user()->avatar); ?>" alt="user" width="60" class="rounded-circle" />
                        </div>
                        <div>
    ...
    <div class="card-group">
        <div class="card">
            <div class="card-body">
                <a href="<?php echo e(route('users',['type' => 'users'])); ?>">
                    <div class="row">
                        <div class="col-12">
        ...
        <div class="card">
            <div class="card-body">
                <a href="<?php echo e(route('users',['type' => 'inst'])); ?>">
                    <div class="row">
                        <div class="col-12">
                            <h3><?php echo e($total_inst); ?></h3>
        ...
        <div class="card">
            <div class="card-body">
                <a href="<?php echo e(route('users',['type' => 'learner'])); ?>">
                    <div class="row">
                        <div class="col-12">
                        <h3><?php echo e($total_learners); ?></h3>
                    ...
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="m-r-20 align-self-center">
                                <h1 class="text-white">
                                    $<?php echo e(number_format($TotalEarning)); ?>

                                </h1>
                            </div>
                            <div>
                                <h4 class="card-title">Total Earning</h4>
                                <h6 class="text-white op-5"><?php echo e(\Carbon\Carbon::now()->format('F Y')); ?></h6>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card bg-cyan text-white">
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="m-r-20 align-self-center">
                                <h1 class="text-white">
                                    $<?php echo e(number_format($InstructorWithDraw)); ?>
...
<script>
    ...
    //     data: [{
    //         label: "Completed",
    //         value: <?php echo e($appt['completed']); ?>,

    //     }, {
    //         label: "Confirmed",
    //         value: <?php echo e($appt['confirmed']); ?>,
    //     }, {
    //         label: "Unconfirmed",
    //         value: <?php echo e($appt['unconfirmed']); ?>,
    //     }],
    //     resize: true,
    ...
    Highcharts.chart('Instructor-chart', {
        ...
        series: [
            {
                data: <?php echo htmlspecialchars(json_encode($InstructorGraph), ENT_QUOTES, 'UTF-8'); ?>,
                name: 'Instructor',
                color: '#1B53B7',
                pointStart: Date.UTC(<?php echo e(date('Y')); ?>, 0),
                pointIntervalUnit: 'month'
            },
            {
                data: <?php echo htmlspecialchars(json_encode($LearnerGraph), ENT_QUOTES, 'UTF-8'); ?>,
                name: 'Learner',
                color: '#3ad010',
                pointStart: Date.UTC(<?php echo e(date('Y')); ?>, 0),
                pointIntervalUnit: 'month'
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp7.4.9\htdocs\firstpass\resources\views/admin/home.blade.php ENDPATH**/ ?>