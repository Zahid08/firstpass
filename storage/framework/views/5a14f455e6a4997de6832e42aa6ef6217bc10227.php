<?php $__env->startSection('content'); ?>
    ...
    <section class="step_choose-sec">
        <div class="step_choose_wrapper">
            <div class="step_choose_tab">
                <a href="javascript:history.back()" class="back_ancor"><button class="step_back_span"><img src="<?php echo url('frontend_assets/images/back-arrow.svg'); ?>" alt="" ><span>Back    </span></button></a>
                <div class="step_tab_img">
                    <img class="img-fluid" src="<?php echo url('frontend_assets/images/step-tabs.svg'); ?>" alt="">
                </div>
            </div>
        </div>
    </section>
    ...
    <form id="book_form" class="w-100">
        ...
        <input type="hidden" value="<?php echo e($region->price); ?>" name="hourly_rate">
        <input type="hidden" value="<?php echo e($test_package->price); ?>" name="test_price">
                ...
                <div class="dl_tooltip_box dl_tooltip">
                    <?php if($showPopup): ?>
                        <p id="instructor-message" class="tooltiptext">
                            <span id="instructor-name"><?php echo e(ucfirst( $instructor->name )); ?></span> only offers a Driving Test
                            Package<br />
                            ...
                            <div class="dl_selection_box">
                                <div class="diving_lessons_checkbox <?=$showPopup?'disable-check':''?>">
                                    <label class="dl-container-checkbox">
                                        <?php if(isset($_REQUEST['test_type']) && $_REQUEST['test_type']!=2): ?>
                                ...
                                <div class="pack_price_list">
                                    ...
                                    <div class="dl_pkg_total">
                                        ...
                                        <div class="pkg_price_total">
                                            <span>Total</span>
                                            <input type="hidden" value="<?php echo e($region->price); ?>" id="drivingLessonPrice">
                                            <span>$<span id="totalPriceCalculations"><?php echo e($region->price); ?></span></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="dl_content_box">
                            <div class="dl_selection_box">
                                <div class="diving_lessons_checkbox">
                                    <label class="dl-container-checkbox">
                                        <input onclick="checkTheBox('test')" id="d_test" type="checkbox" name="d_test" <?php echo e((isset($_REQUEST['type']) && $_REQUEST['type']=='package')?'checked':''); ?>/>
                                        <span class="dl_checkmark"></span>
                                    </label>
                                </div>
                            </div>
            ...
            $.ajax({
                ...
                success: function (res) {
                    ...
                    if(res.success == true){
                        ...
                        let url = "<?php echo e(url("/book-online/book/$search_id/instructor/$instructor->id")); ?>";
...
<?php echo $__env->make('frontend.layouts.cart',['mainclass'=>'cart'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp7.4.9\htdocs\firstpass\resources\views/search/book_online.blade.php ENDPATH**/ ?>