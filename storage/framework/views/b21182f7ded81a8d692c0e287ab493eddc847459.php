                ...
                <div class="offcanvas-body w-100">
                    <div class="row w-100 d-flex align-items-center m-0 overflow-hidden">
                        <ul class="navbar-nav col-xl-4 col-lg-5 p-0">
                            <li class="nav-item">
                                <a class="nav-link" aria-current="page" href="<?php echo e(URL::to ('/')); ?>">Home</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo e(URL::to ('/driving-lessons')); ?>">Driving lessons</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo e(URL::to ('/driving-lessons/test-package')); ?>">Test packages</a>
                            </li>
                        </ul>
                        ...
                        <ul class="navbar-nav col-xl-4 col-lg-5 d-flex align-items-center justify-content-end p-0 contact_navbar">
                            ...
                            <?php if(auth()->user()): ?>
                                <li>
                                    <a class="nav-link" href="<?php echo e(URL::to ('/login')); ?>">My Account</a>
                                </li>
                            <?php endif; ?>
...
<?php /**PATH /home/zenstech/public_html/resources/views/frontend/layouts/partials/header3.blade.php ENDPATH**/ ?>