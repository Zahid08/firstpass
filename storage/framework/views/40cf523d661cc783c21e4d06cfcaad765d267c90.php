    ...
    <div class="container-fluid">
        ...
        <div class="card-group">
            ...
            <div class="card">
                ...
                <a href="<?php echo e(url('appointments?type=total')); ?>">
            ...
            <div class="card">
                ...
                <a href="<?php echo e(url('appointments?type=completed')); ?>">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                ...
                                <h3><?php echo e($TotalLessonCompleted); ?></h3>
            ...
            <div class="card">
                ...
                <a href="<?php echo e(url('appointments?type=learner')); ?>">
                ...
                <div class="card">
                    ...
                    <div class="card-body p-b-0">
                        ...
                        <?php if(isset($UpcomingAppointment->avatar)): ?>
                            ...
                            ?>
                            <h4 class="card-title" style="font-weight: 700;color: orangered">Your lesson <?php echo e($days); ?><!-- <?php echo e(\Carbon\Carbon::parse($UpcomingAppointment->schedule_date)->format('j F Y')); ?> --></h4>
                            ...
                            <div class="row <?php if($UpcomingAppointment->time_slot == ''): ?> bg-danger text-white <?php endif; ?>" <?php if($UpcomingAppointment->time_slot == ''): ?> data-toggle="tooltip" data-title="Instructor can't approve a lesson if time is missed, please add schedule time" <?php endif; ?>>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <?php elseif($UpcomingAppointment->status=='cancelled'): ?>
                                        <div>
                                            <span style="background: #8080803b; padding: 4px; font-weight: 500;padding-right: 12px;padding-left: 12px;border-radius: 10px;">Cancelled By Lerner</span>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <!-- <span style="font-weight: 600; font-size: 18px;"><?php echo e($appointment->apptype == "test" ? "Auto Driving Test" : "Auto Lesson - ".$appointment->lesson_hour." hour"); ?><?php echo e($appointment->lesson_hour > 1 ? "s" : ""); ?></span><br> -->
                                            ...
                                            <?php if($appointment->status=='confirmed'): ?>
                                                <div>
                                                    <a  href="javascript:;" onclick="ShowTimeSlots(this)" data-date="<?=date('D, d F, Y', strtotime($appointment->schedule_date))?>" data-time="<?=$appointment->time_slot?>" data-name="<?php echo e(ucwords($appointment->name .' '. $appointment->lname)); ?>" data-id="<?=$appointment->id?>" data-search-id="<?=$appointment->search_id?>" data-instructor-id="<?=$appointment->instructor_id?>" data-start-date="<?=$appointment->schedule_date?>" class="btn btn-success" style="margin-bottom: 20px;margin-right: 10px;border-radius: 8px;"><i class="fa fa-check-square"></i> Authorize or Wave Payment</a>
                                                </div>
                            ...
                            <div class="w-100" >
                                ...
                                <?php if($BookingHistory->isNotEmpty()): ?>
                                    ...
                                    <?php $__currentLoopData = $BookingHistory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $appointment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="row <?php if($appointment->time_slot == ''): ?> bg-danger text-white <?php endif; ?>" <?php if($appointment->time_slot == ''): ?> data-toggle="tooltip" data-title="Instructor can't approve a lesson if time is missed, please add schedule time" <?php endif; ?>>
                                            ...
                                            <div class="col-md-6" style="margin-bottom: 15px;">
                                                ...
                                                <p>
                                                    ...
                                                    <span style="font-weight: 600; line-height: 35px;" id="gettingHourRate"><?php echo date('D, d F, Y', strtotime($appointment->schedule_date)); ?> <br>Pickup time: <?php echo e($pickuptime); ?><br>Start time: <?php echo e($startT); ?></span><br> <?php
                    ...
                    <form id="book_time" method="post">
                        ...
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Payment Authorized</h5>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="" id="checkingOptionsForNo" style="padding: 10px;border: 1px solid green;border-radius: 10px;display: none">
                                                <p style=" margin-bottom: 0;font-size: 18px;font-weight: 500;">if you choose to charge the learner you are declaring that the learner is at fault and did not attend the lessong as sceduled.</p><br/>
                                                <input style="" class="" checked type="radio" name="cancel_options" value="cancelled_payment_wave"> <span style="font-size: 16px;font-weight: 500;">Cancel & Payment Waived</span><br/>
                                                <input style="" class="" type="radio" name="cancel_options" value="no_charge"> <span style="font-size: 16px;font-weight: 500;">No Show Charge</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="card bg-light">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center flex-row m-t-30">
                            ...
                            <h2><strong>$<?php echo e((isset($TotalAmount))? $TotalAmount : '0'); ?></strong></h2>
                ...
                <div class="card bg-light">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center flex-row m-t-30">
                            ...
                            <h2><strong>$<?php echo e((isset($GetCompletedAppointmentsAmount))? $GetCompletedAppointmentsAmount : '0'); ?></strong></h2>

                        </div>

                        <?php if(isset($GetCompletedAppointmentsAmount) && $GetCompletedAppointmentsAmount > 0 ): ?>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script src="<?php echo e(asset('assets/js/pages/dashboards/dashboard3.js')); ?>"></script>
        ...
        $(document).ready(function() {
            ...
            $('#withdraw_form').submit(function (){
                ...
                $.ajax({
                    ...
                    url: "<?php echo e(route('withdraw-amount')); ?>",
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    if (InstructorID && AppointmentID){
                        ...
                        if (status){
                            $.post('<?php echo e(route("Change-appointment-status")); ?>',{AppointmentID:AppointmentID, InstructorID:InstructorID,status:status},function(res){
                                $("#loading").hide();
                                if(res.success==true){
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/zenstech/public_html/resources/views/instructor/home.blade.php ENDPATH**/ ?>