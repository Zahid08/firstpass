                            ...
                            <form id="edit_instructor">
                                <div id="instrutor-profile-container">
                                    ...
                                    <div id="service_regions">
                                        <?php $__currentLoopData = $user_regions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $region): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <label class="label label-inverse m-r-5 m-b-5 p-2"> <?php echo e($region->region->title); ?> </label>
                                    ...
                                    <label for=""><span class="text-danger">*</span> Your operating hours</label>
                                        ...
                                        The management of your real time availability within your operating hours is done via your <?php echo e(env('APP_NAME')); ?> calendar, you will have access to this once you have completed the signup process. Before we begin showing your live availability to learners, your <?php echo e(env('APP_NAME')); ?> calendar will need to be updated with all your existing bookings, this is to prevent double bookings. Your <?php echo e(env('APP_NAME')); ?> calendar needs to be updated by you each time you make new or change existing bookings. You are only required to add the duration of the lessons, not any learner detail. We also provide the opportunity to nominate travel times.</p>
                                        ...
                                        <div class="card-body">
                                            <div class="col-md-12">
                                                ...
                                                <div class="table-responsive">
                                                    ...
                                                    <?php if( count($working_time) ==0 ): ?>
                                                    <?php
                                                    $days = ['sunday', 'monday', 'tuesday', 'wednesday', 'thursday', 'friday', 'saturday'];
                                                    foreach ($days as $day){
                                                    ?>
                                                    <tr class="<?php echo e($day); ?>_">
                                                        <td>
                                                            <div class="form-group">
                                                                <div class="controls">
                                                                    <div class="custom-control custom-checkbox">
                                                                        <input type="checkbox" name="is_enabled[<?php echo e($day); ?>]" value="yes" id="customCheck_<?php echo e($day); ?>" class="custom-control-input">
                                                                        <input type='hidden' value='no' name='is_enabled[<?php echo e($day); ?>]'>
                                                                        <!--<input type='hidden' name='days[<?php echo e($day); ?>][]' value="<?php echo e($day); ?>">-->
                                                                        <input type="hidden" class="form-control" name="service_time_id[<?php echo e($day); ?>]" value="">

                                                                        <label class="custom-control-label" for="customCheck_<?php echo e($day); ?>"><?php echo e(ucwords($day)); ?> <i class="fa fa-times text-danger"></i></label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="row">
                                                                <div class="col-md-5 col-sm-12">
                                                                    <div class="form-group">
                                                                        <div class="controls">
                                                                            <select name="start_interval[<?php echo e($day); ?>][]" id="<?php echo e($day); ?>_start"  class="form-control">
                                                                            <?php
                                                                ...
                                                                <div class="col-md-5 col-sm-12">
                                                                    <select name="start_minutes[<?php echo e($day); ?>][]" class="form-control">
                                                        ...
                                                        <td>
                                                            <div class="row">
                                                                <div class="col-md-5 col-sm-12">
                                                                    <div class="form-group">
                                                                        <div class="controls">
                                                                            <select name="end_interval[<?php echo e($day); ?>][]" id="<?php echo e($day); ?>_end"  class="form-control">
                                                                                <?php
                                                                                foreach(@$timeslot as $slot){
                                                                                    $selected = "";
                                                                                    if($slot->time_value == 9){$selected = 'selected="selected"';}
                                                                ...
                                                                <div class="col-sm-12 col-md-2 text-center">:</div>
                                                                <div class="col-md-5 col-sm-12">
                                                                    <select name="end_minutes[<?php echo e($day); ?>][]" class="form-control">
                                                                        <option value="00">00</option>
                                                        ...
                                                        <td>
                                                            <button onclick="add_time(this, '<?php echo e($day); ?>')" type="button" class="btn btn-xs btn-primary pull-right"> <i class="fa fa-clock"></i> Add another time </button>
                                                        </td>

                                                    </tr>
                                                    <?php } ?>
                                                        <?php else: ?>
                                                        <?php $__currentLoopData = $working_time; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <?php
                                                            $data = json_decode($val->data);
                                                            foreach($data as $i => $value){
                                                            ?>

                                                            <tr class="<?php echo e($val->day); ?>_">
                                                                <td>
                                                                    <?php if($i==0 ){ ?>
                                                                    <div class="form-group">
                                                                        <div class="controls">
                                                                            <div class="custom-control custom-checkbox">
                                                                                <input <?php echo e($val->is_enabled == "yes"? 'checked':''); ?> data-a="" type="checkbox" name="is_enabled[<?php echo e($val->day); ?>]" value="yes" id="customCheck_<?php echo e($val->day); ?>" class="custom-control-input">
                                                                                <input type='hidden' value='no' <?php echo e($val->is_enabled == "yes"? 'disabled':''); ?> name='is_enabled[<?php echo e($val->day); ?>]'>
                                                                                <label class="custom-control-label" for="customCheck_<?php echo e($val->day); ?>"><?php echo e(ucwords($val->day)); ?> <i class="ml-1 fa <?php echo e($val->is_enabled == "yes"? 'fa-check text-success':'fa-times text-danger'); ?>"></i></label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <?php
                                                                    ...
                                                                    ?>
                                                                        <input type="hidden" class="form-control" name="service_time_id[<?php echo e($val->day); ?>]" value="<?php echo e($val->id); ?>">
                                                                </td>
                                                                <td>
                                                                    <div class="row">
                                                                        <div class="col-md-5 col-sm-12">
                                                                            <div class="form-group">
                                                                                <div class="controls">
                                                                                    <select name="start_interval[<?php echo e($val->day); ?>][]" id="<?php echo e($val->day); ?>_start"  class="form-control">
                                                                                        <?php
                                                                                        foreach($timeslot as $slot){
                                                                        ...
                                                                        <div class="col-sm-12 col-md-2 text-center">:</div>
                                                                        <div class="col-md-5 col-sm-12">
                                                                            <select name="start_minutes[<?php echo e($val->day); ?>][]" class="form-control">
                                                                                <option <?php echo e($value->start_min == "00" ? "selected" : ""); ?> value="00">00</option>
                                                                                <option <?php echo e($value->start_min == "15" ? "selected" : ""); ?> value="15">15</option>
                                                                                <option <?php echo e($value->start_min == "30" ? "selected" : ""); ?> value="30">30</option>
                                                                                <option <?php echo e($value->start_min == "45" ? "selected" : ""); ?> value="45">45</option>
                                                                            </select>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                                ...
                                                                <td>
                                                                    <div class="row">
                                                                        <div class="col-md-5 col-sm-12">
                                                                            <div class="form-group">
                                                                                <div class="controls">
                                                                                    <select name="end_interval[<?php echo e($val->day); ?>][]" id="<?php echo e($val->day); ?>_end"  class="form-control">
                                                                                        <?php
                                                                                        foreach(@$timeslot as $slot){
                                                                                            $selected = "";
                                                                        ...
                                                                        <div class="col-sm-12 col-md-2 text-center">:</div>
                                                                        <div class="col-md-5 col-sm-12">
                                                                            <select name="end_minutes[<?php echo e($val->day); ?>][]" class="form-control">
                                                                                <option <?php echo e($value->end_min == "00" ? "selected" : ""); ?> value="00">00</option>
                                                                                <option <?php echo e($value->end_min == "15" ? "selected" : ""); ?> value="15">15</option>
                                                                                <option <?php echo e($value->end_min == "30" ? "selected" : ""); ?> value="30">30</option>
                                                                                <option <?php echo e($value->end_min == "45" ? "selected" : ""); ?> value="45">45</option>
                                                                            </select>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <td>
                                                                    <?php if($i!=0){ ?>
                                                                    <button onclick="remove_time(this, <?php echo e($val->id); ?>)" type="button" class="btn btn-xs btn-danger pull-right"> <i class="fa fa-trash"></i> </button>
                                                                    <?php }else{ ?>
                                                                    <button onclick="add_time(this, '<?php echo e($val->day); ?>')" type="button" class="btn btn-xs btn-primary pull-right"> <i class="fa fa-clock"></i> Add another time </button>
                                                                    <?php } ?>
                                                                </td>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select multiple="" class="select2_test_locations form-control" name="test_location_ids[]" id="test_location_ids">
                                                        ...
                                                        $selected="";
                                                        ?>
                                                        <option selected value="<?php echo e($test_location->id); ?>"><?php echo e($test_location->title); ?></option>
                                                        <?php } ?>
                                                    </select>
                                                </div>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="lesson_travel_time" id="" class="form-control">
                                                                <option <?php echo e(auth()->user()->lesson_travel_time==15? 'selected': ''); ?> value="15">15</option>
                                                                <option <?php echo e(auth()->user()->lesson_travel_time==30? 'selected': ''); ?> value="30">30</option>
                                                                <option <?php echo e(auth()->user()->lesson_travel_time==45? 'selected': ''); ?> value="45">45</option>
                                                                <option <?php echo e(auth()->user()->lesson_travel_time==60? 'selected': ''); ?> value="60">60</option>
                                                                <option <?php echo e(auth()->user()->lesson_travel_time==75? 'selected': ''); ?> value="75">75</option>
                                                                <option <?php echo e(auth()->user()->lesson_travel_time==90? 'selected': ''); ?> value="90">90</option>
                                                                <option <?php echo e(auth()->user()->lesson_travel_time==105? 'selected': ''); ?> value="105">105</option>
                                                                <option <?php echo e(auth()->user()->lesson_travel_time==120? 'selected': ''); ?> value="120">120</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <select name="user_regions[]" multiple="" class="form-control select2_regions" id="user_regions" style="width: 100%">
                                                                ...
                                                                ?>
                                                                <option <?php echo e($selected); ?> value="<?php echo e($region->id); ?>"><?php echo e($region->title); ?></option>
                                                                <?php } ?>
                                                            </select>
                                                        </div>
                                                    </div>
    ...
    <script>
        function update_regions()
        {
             var service_regions = $("#user_regions").val();
               $.ajax({
                    url: "<?php echo e(Route('update_user_region')); ?>",
    ...
    <script>
        ...
        function add_time(e, day){
            ...
            var htm = '<tr class="'+day+'_">' +
                ...
                <?php $__currentLoopData = $timeslot; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    '<option data-dt="" <?php echo e($slot->time_value == 9? 'selected':''); ?> value="<?php echo e($slot->time_value); ?>"><?php echo e($slot->time_value); ?></option>'+
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                '</select>' +
                '</div>'+
                '            </div>'+
        ...
        $(document).ready(function() {
            ...
            $('.select2_test_locations').select2({
                ...
                ajax: {
                    url: '<?php echo e(url('autocomplete-test-locations')); ?>',
                    dataType: 'json',
                    delay: 250,
            ...
            $('#edit_instructor').submit(function (){
               ...
               errors.html('');
                ...
                $.ajax({
                    url: "<?php echo e(Route('save_service_regions')); ?>",
                    data: data,
                    contentType: false,
                    processData: false,
                    type: 'POST',
                    success: function (res) {
                        if(res.success == true){
                            ...
                            Swal.fire({
                                ...
                                if (result.value) {
                                    document.location.href = "<?php echo e(route('services_availability')); ?>";
                                }
                            })
        ...
        function initMap(map_id=null, latLng=null) {

            var lat = latLng ? latLng.lat : parseFloat("<?php echo e($lat); ?>");
            var lng = latLng ? latLng.lng : parseFloat("<?php echo e($long); ?>");
                    ...
                    function(results, status) {
                        if (status == google.maps.GeocoderStatus.OK) {
                            if (results[1]) {
                                ...
                                var region = info[info.length - 2];
                                region = region.substring(1, region.length);
                                var seleted_option =  $("#user_regions").find('option').filter(function(){
                                    return $(this).text() == region;
                                }).prop('selected', 'selected');
                                $("#user_regions").append(seleted_option);
                                service_regions = $("#user_regions").val();
                                initMap('editMap', mapsMouseEvent.latLng.toJSON());
                            }
                        }
                    }
                );
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/zenstech/public_html/resources/views/instructor/services_and_availability.blade.php ENDPATH**/ ?>