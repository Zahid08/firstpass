...
<?php $__env->startSection('content'); ?>
    ...
    <link href="<?php echo e(asset('assets/libs/select2/dist/css/select2.min.css')); ?>" rel="stylesheet" type="text/css" />
    ...
    <div class="_package_page_tab" style="<?php if(isset($_REQUEST['type']) && $_REQUEST['type']=='package'): ?> padding-top:100px;<?php endif; ?>">
        <?php if(isset($_REQUEST['type']) && $_REQUEST['type']=='package'): ?>
        <?php else: ?>
            <img src="<?php echo url ('frontend_assets/images/package-top-banner.svg'); ?>" class="img-fluid w-100" alt="">
                ...
                <div class="package_instructor_box">
                    <div class="pack_detail_box pack_detail_box_one">
                        <div class="pack_detail_box_head">
                            ...
                            <p><?php echo e($total); ?> Auto Instructors Available in</p>
                            <p class="bold"><?php if($region): ?> <?php echo e($region->title); ?> <?php endif; ?> </p>
                        </div>
                    </div>
                                ...
                                <div class="pkg_filter_box">
                                    ...
                                    <div class="gender_check_list">
                                        <div class="form-check filter-inst-field">
                                            ...
                                            <label class="form-check-label" for="male"><img src="<?php echo url ('frontend_assets/images/male-profile-icon.svg'); ?>" alt="">Male</label>
                                        </div>
                                        <div class="form-check filter-inst-field">
                                            <input class="form-check-input" type="radio" name="gender" id="female" data-field="gender" data-val="female" value="female">
                                            <label class="form-check-label" for="female"><img src="<?php echo url ('frontend_assets/images/female-profile-icon.svg'); ?>" alt="">Female</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="container p-0">
                <div class="row m-0">
                    <div class="instructor_box_mob col-12">
                        <h3>Choose Instructor</h3>
                        <p><?php echo e($total); ?> Auto Instructors Available in<br>
                                    ...
                                    <div class="pkg_filter_box">
                                        ...
                                        <div class="gender_check_list">
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label" for="male_mob"><img src="<?php echo url ('frontend_assets/images/male-profile-icon.svg'); ?>" alt="">Male</label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="gender" id="female_mob" data-field="gender" data-val="female" value="female">
                                                <label class="form-check-label" for="female_mob"><img src="<?php echo url ('frontend_assets/images/female-profile-icon.svg'); ?>" alt="">Female</label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="package_instructor_box">
                            ...
                            <div class="pack_detail_box pack_detail_box_three">
                                <div class="test_pack_price">
                                    ...
                                    <h2>$<span id="testpackge_price"><?php echo e($test->price); ?></span></h2>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <section class="pkg_profilebox_sec">
            <div class="pkg_profile_wrapper">
                <div class="pkg_profile_row">
                    <div class="<?php if(!$users->isEmpty()): ?> pkg_profile_grid <?php endif; ?>" id="instructorGrid">
                              ...
                              <div class="pkg_profile_card">
                                    ...
                                    <div class="pkg_icard_content">
                                        <div class="pkg_icard_head">
                                            <h3 class="pkg_icard_name"><?php echo e($name); ?></h3>
                                            <span class="pkg_icard_lang">Speaks <?php echo e($language); ?>

                                          </span>
                                        </div>
                                        <div class="pkg_icard_buttons">
                                            <a href="<?php echo e(url('/search/'.$search_id.'/instructors/profile/'.$user->id)); ?>" class="icard_button_profile">
                                                <span> View Profile </span>
                                            </a>
                                            <button class="icard_button_times" data-id="<?php echo e($user->id); ?>" onclick="return openCal('<?php echo e($user->id); ?>', '<?php echo e($name); ?>', '<?php echo e($search_id); ?>');">
                                                <img src="<?php echo url('frontend_assets/images/pro-calender-icon.svg'); ?>" alt="">
                                                <span> Available Times</span>
                                            </button>
                                        </div>
                                        <a href="<?php echo e(url('book-online/'.$search_id.'/instructor/'.$user->id)); ?><?php echo e(isset($_REQUEST['type']) && $_REQUEST['type']=='package'?'?type='.$_REQUEST['type'].'&test_type='.$_REQUEST['test_type']:''); ?>" class="pkg_icard_book_btn">
                                            Book Now
                                        </a>
                                    </div>
                                </div>
...
<script type="text/javascript">
    ...
    function openCal(inst_id, inst_name, search_id){
        ...
        $('#book_btn').attr("href", base_url+"book-online/"+search_id+"/instructor/"+inst_id+'?type=<?php echo e(isset($_REQUEST['type']) && $_REQUEST['type']=='package'?$_REQUEST['type']:''); ?>&test_type=<?php echo e(isset($_REQUEST['type']) && $_REQUEST['type']=='package'?$_REQUEST['test_type']:''); ?>');
    ...
    $(document).on('click', '.openCal', function (e) {
        ...
        $('#availability_modal').modal('show');
        $('#show_name').html('Book With '+inst_name);
        $('#book_btn').attr("href", "book-online/"+search_id+"/instructor/"+inst_id+'?type=<?php echo e(isset($_REQUEST['type']) && $_REQUEST['type']=='package'?$_REQUEST['type']:''); ?>&test_type=<?php echo e(isset($_REQUEST['type']) && $_REQUEST['type']=='package'?$_REQUEST['test_type']:''); ?>');
    ...
    var search_id = "<?php echo e($search_id); ?>";
    ...
    function doFilter(field){
        ...
        <?php if(isset($_REQUEST['type']) && $_REQUEST['type']='package'): ?>
            ...
            extraUrl='?type=<?php echo e($_REQUEST['type']); ?>&test_type=<?php echo e($_REQUEST['test_type']); ?>&test_location=<?php echo e($_REQUEST['test_location']); ?>'
        <?php endif; ?>

        $.ajax({
            url: "<?php echo e(url('search-filter')); ?>/"+search_id+extraUrl,
                ...
                if(res.message.length > 0){
                    for (var a = 0; a < res.message.length; a++) {
                        ...
                        html=`<div class="pkg_profile_card">
                                    <div class="pkg_icard_img">
                                                <img src="<?php echo e(url("assets/images/users/")); ?>/${user_img}" alt="user">
                                        </div>
                                    <div class="pkg_icard_content">
                                        <div class="pkg_icard_head">
                                        ...
                                        <div class="pkg_icard_buttons">
                                            <a href="<?php echo e(url("/search/".$search_id."/instructors/profile/")); ?>/${user_id}" class="icard_button_profile">
                                                <span> View Profile </span>
                                            </a>
                                            <button class="icard_button_times" data-id="${user_id}" onclick="return openCal('${user_id}', '${user_name}', '<?php echo e($search_id); ?>');">
                                                <img src="http://localhost/firstpass/frontend_assets/images/pro-calender-icon.svg" alt="">
                                                <span> Available Times</span>
                                            </button>
                                        </div>
                                        <a href="<?php echo e(url('book-online/'.$search_id.'/instructor/')); ?>/${user_id}?type=<?php echo e(isset($_REQUEST['type']) && $_REQUEST['type']=='package'?$_REQUEST['type']:''); ?>&test_type=<?php echo e(isset($_REQUEST['type']) && $_REQUEST['type']=='package'?$_REQUEST['test_type']:''); ?>" class="pkg_icard_book_btn">
                                            Book Now
                                        </a>
                                    </div>
                                </div>`
...
<?php echo $__env->make('frontend.layouts.search', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp7.4.9\htdocs\firstpass\resources\views/search/result.blade.php ENDPATH**/ ?>