...
Route::get('driving-lessons/test-package', 'GuestController@test_package')->name('testpack');
Route::get('driving-lessons', 'GuestController@driving_lesson');
...
Route::get('/get-test-location-1', 'GuestController@get_test_t_location')->name('test_t_location');
...
Route::get('/login-demo', 'GuestController@relogin')->name('login-demo');

Route::get('/paypal/cancel', function () {
    return 'Payment cancelled!';
})->name('paypal.cancel');
Route::get('/paypal/success', 'GuestController@successPaypalRequest')->name('paypal.success');


Route::get('/afterpay/success', 'GuestController@successAfterPayRequest')->name('afterpay.success');

Route::get('/zippay/success', 'GuestController@successZipPayRequest')->name('afterpay.success');

/*Zip Pay Payment Add*/
Route::get('/zippay/callback', 'GuestController@handleZipPayCallback')->name('zipay.callback');
...
Route::group(['middleware' => ['auth', 'verified']], function(){
    ...
    Route::get('buy-more-credit', 'InstructorController@buy_more_credit')->name('buy_more_credit');
