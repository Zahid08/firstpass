        ...
        <div class="step_choose_wrapper">
            <div class="step_choose_tab">
                ...
                <div class="step_tab_img">
                    <img class="img-fluid" src="{!! url('frontend_assets/images/step-tabs-2.svg') !!}" alt="">
                </div>
            </div>
        </div>
    </section>
...
{{--                 Added Cart Item--}}
                ...
                <div class="driving_lesson mb-4 d-none" id="popoverDrivingLesson">
                    <div class="menu_close-btn" id="closePopover">
                        <img src="{!! url('frontend_assets/images/cross.png') !!}" alt="">
                    </div>
...
@section('scripts')
    <script>
        ...
        $(document).on('submit','#book_time', function(event){
            ...
            var search_url ='{{Route('search')}}?total=' + $('#total_hours').val();
            $('#total_hours').val(0);
