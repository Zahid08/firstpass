...
@section('content')
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="media medium-margin-bottom-10">
                                        ...
                                        <div class="media-left va-b medium-padding-right-20">
                                            ...
                                            <div><a class="btn btn-default tiny oil small-fontsize-14 back_ancor " href="javascript:history.back()"><i class="fa fa-angle-left fa-left"></i>Back</a></div>
    ...
    @else
        ...
        <div class="text-center">
            ...
            @if( $instructor->avatar == '')
                ...
                <img class="img-circle img-featured" src="{{ url('assets/images/users/default.png') }}" alt="user" style="height: 60px; width: 60px">

            @else

                <img class="img-circle img-featured" src="{{ url('assets/images/users/'.$instructor->avatar) }}" alt="user" style="height: 60px; width: 60px">
    ...
    <section class="ls container container-cx mt-4">
        ...
        <div class="row c-gutter-8">
            ...
            if( ($step_2 && in_array('lesson', $step_2))  || auth()->user()){
                                    ...
                                    <form id="book_time">
                                        ...
                                        <div class="main_continue form-group w-100 text-center mt-4">
                                            ...
                                            @if($search->step_2 =='' && auth()->user())
                                                ...
                                                <button id="confirm_button" class="btn btn-block btn-warning btn-lg" disabled>CONFIRM BOOKING(S)</button>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $( ".lesson_time_hidden" ).on( "click", ".del_selected", function(e){
                ...
                var select_hour = parseInt($('input[type=radio]:checked').val());
                ...
                if($(".lesson_time_hidden .selected-wraper").length < 1){
        ...
        $(document).ready(function (){
            ...
            $('#book_time').submit(function (){
                ...
                */
                ...
                var search_url = '/app/search?total=' + $('#total_hours').val();
