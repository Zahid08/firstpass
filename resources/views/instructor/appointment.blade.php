                        ...
                        <?php 
                              ...
                              //echo $daysleft;
                                if($future==$now){
                                 ...
                                 ?>
                        <h4 class="card-title">YOUR NEXT LESSON IN {{$days}}<!-- {{\Carbon\Carbon::parse($UpcomingAppointment->schedule_date)->format('j F Y')}} --></h4>
                            ...
                            <div class="col-md-6">
                                ...
                                <p>
                                  ...
                                  ?>
                                            ...
                                            <span style="font-weight: 600; font-size: 18px;">{{$title}}{{ $UpcomingAppointment->lesson_hour > 1 ? "s" : "" }}</span><br>
                    ...
                    <h4 class="card-title">Booking History</h4>
                        ...
                        @if($BookingHistory->isNotEmpty())
                            ...
                            @foreach($BookingHistory as $appointment)
                                ...
                                <h4 class="card-title">Your lesson was on {{\Carbon\Carbon::parse($appointment->schedule_date)->format('j F Y')}}</h4>
                                ...
                                <div class="row">
                                  ...
                                  ?>
                                            ...
                                            <span style="font-weight: 600; font-size: 18px;">{{$title}}{{ $appointment->lesson_hour > 1 ? "s" : "" }}</span><br>
