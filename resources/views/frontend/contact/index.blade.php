@extends('frontend.layouts.login',['mainclass'=>'contact_form'])
@section('content')
            ...
            <div class="col-md-6 px-0 form_col_bg d-flex align-items-center">
                <div class="form_content_box contact_box mx-auto w-100">
                    ...
                    <div class="form_body">
                        ...
                        @endif
                        <form class="row gx-4 gx-md-5 contact-form" id="contact-form" action="{{ route('save-contact-form') }}" method="post">
                            @csrf
