                ...
                <div class="offcanvas-body w-100">
                    <div class="row w-100 d-flex align-items-center m-0 overflow-hidden">
                        <ul class="navbar-nav col-xl-4 col-lg-5 p-0">
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{ request()->is('driving-lessons') ? 'active' : '' }}" href="{{URL::to ('/driving-lessons')}}">Driving lessons</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link {{ request()->is('driving-lessons/test-package') ? 'active' : '' }}" href="{{URL::to ('/driving-lessons/test-package')}}">Test packages</a>
                            </li>
                        </ul>
                        ...
                        <ul class="navbar-nav col-xl-4 col-lg-5 d-flex align-items-center justify-content-end p-0 contact_navbar">
                            <li class="nav-item">
                                <a class="nav-link" href="{{URL::to ('/contact')}}" style="color: black">Contact</a>
                            </li>
                            @if(auth()->user())
                                <li>
                                    <a class="nav-link" href="{{URL::to ('/login')}}" style="color:black">My Account</a>
                                </li>
                            @endif
