@extends('frontend.layouts.driving_leason')
@section('content')
    ...
    <section class="driving_lessons_banner position-relative">
        <img src="{!! url ('frontend_assets/images/driving-lessons-banner.jpg') !!}" class="img-fluid d-lg-block d-none" alt="">
        <img src="{!! url ('frontend_assets/images/driving-lessons-mob-new.jpg') !!}" class="img-fluid d-lg-none d-md-block d-none tab-banner" alt="">
        <img src="{!! url ('frontend_assets/images/driving-lessons-mob-new.jpg') !!}" class="img-fluid d-md-none d-block mob-banner" alt="">
                ...
                <div class="col-lg-12">
                    <div class="ed_content_container">
                        <div class="easy-driving_img-ctn">
                            <img class="tablet-easy-img" src="{!! url ('frontend_assets/images/one-way.svg') !!}" alt="">
                        </div>
                        <div class="ed_content">
                            <div class="points_easier_list">
                                <ul>
                                    <li><img src="{!! url ('frontend_assets/images/easy-driving_radio.svg') !!}" alt=""> Enter Your Subrub</li>
                                    <li><img src="{!! url ('frontend_assets/images/easy-driving_radio.svg') !!}" alt=""> Find Instructor</li>
                                    <li><img src="{!! url ('frontend_assets/images/easy-driving_radio.svg') !!}" alt=""> Start Learning</li>
                                </ul>
                            </div>
            ...
            <div class="row">
                <div class="col-lg-12 p-0">
                    <div class="add_more_img text-end">
                        <img src="{!! url ('frontend_assets/images/more-img.png') !!}" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row align-content-center">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="dl_pricing_img">
                        <img class="img-fluid" src="{!! url ('frontend_assets/images/driving-pricing-car.svg') !!}" alt="">
                    </div>
                </div>
            </div>
        </div>
