                    ...
                    <div class="card-body">
                        <center class="m-t-30">
                            @if($user->avatar == '')
                                ...
                                @else
                                <img src="{{ asset('assets/images/users/default-female.png') }}" id="profile-image-preview" class="image_preview img-circle avatar-default" width="150">
                                @endif
                            @else
                            ...
                            <form class="form-horizontal form-material" id="profileForm" enctype="multipart/form-data">
                                ...
                                @if($user->type == "inst")
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" value="{{ @$user->business_name }}" name="business_name" placeholder="Business Name" class="form-control form-control-line">
                                        </div>
                                    </div>
                                @endif
                                <?php
